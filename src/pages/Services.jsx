...
export default function Services() {
  ...
  // Build pillar list with icon sourced from the first service in each pillar
  ...
  // Group filtered services by pillar
      ...
      <div className="section-wrap">
        ...
        {!loading && (
          ...
          >
            ...
            <Link to="/contact" className="btn-primary btn-lg">Talk to Me</Link>
          </div>
        )}
...
function EmptyState({ hasSearch, onClear, isFiltered }) {
  if (hasSearch) {
    return (
      <div className="text-center py-20">
        ...
        <button onClick={onClear} className="btn-secondary btn-md">
          Clear Search
        </button>
      </div>
    )
  ...
  if (isFiltered) {
    return (
      <div className="text-center py-20">
        <div className="text-4xl mb-4">📂</div>
        <h3 className="heading-section mb-2 text-gray-500">
          No services in this category
        </h3>
        <p className="text-body text-gray-400 mb-6">
          Select a different category or view all services.
        </p>
        <button onClick={onClear} className="btn-secondary btn-md">
          View All
        </button>
  ...
  return (
    <div className="text-center py-20">
      ...
      <p className="text-body text-gray-400 mb-6">
        Services will appear here once they&rsquo;re published.
      </p>
