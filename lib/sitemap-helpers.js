...
// pages: [{ url, lastmod, freq, priority, images?: [{ loc, title?, caption? }] }]
export function buildUrlset(pages) {
  const hasImages = (pages || []).some(p => p.images?.length)
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"${hasImages ? '\n        xmlns:image="http://www.google.com/schemas/sitemap-image/1.1"' : ''}
