...
export default function GigDetail() {
  ...
  if (!gig) return <div className="min-h-screen flex items-center justify-center bg-soft"><div className="text-center"><p className="text-body text-gray-500 mb-4">Gig not found.</p><Link to="/gigs" className="btn-primary btn-md">← Back to Gigs</Link></div></div>

  return (
    <div className="min-h-screen pt-24 pb-24 bg-soft">
      <div className="section-narrow">
        <Link to="/gigs" className="text-body-sm font-semibold text-gray-400 hover:text-accent flex items-center gap-1 mb-8 transition-colors">← Back to Gigs</Link>
        <div className="mb-14">
