...
export async function GET() {
  ...
  const pages = [
    ...
    { url: `${baseUrl}/services/meta-ads-management`,          freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/linkedin-ads-management`,      freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/tiktok-ads-management`,        freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/tracking-attribution-analytics`, freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/landing-page-cro`,              freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/ppc-audit`,                     freq: 'monthly', priority: '0.8', lastmod: today },
    { url: `${baseUrl}/services/white-label-ppc`,               freq: 'monthly', priority: '0.8', lastmod: today },
