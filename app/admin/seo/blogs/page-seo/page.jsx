  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-extrabold text-white">Blogs Listing Page</h1>
        <p className="text-sm text-gray-400 mt-1">SEO settings for the main /blogs listing page</p>
      </div>
